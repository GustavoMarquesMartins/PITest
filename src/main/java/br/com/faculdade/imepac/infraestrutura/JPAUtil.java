...
/**
 * Classe utilitária para fornecer e gerenciar instâncias de EntityManager para
...
public class JPAUtil {
    ...
    /**
     * Fecha a conexão com o banco de dados de produção. Este método deve ser
     * chamado quando a aplicação estiver sendo desligada ou quando não for mais
     * necessário interagir com o banco de dados de produção.
     */
